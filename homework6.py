...
number_iterations = st.slider("Please choose the number of iterations to find 5 clusters", min_value=1)
...
kmeans = KMeans(n_clusters = 5, max_iter=number_iterations, init=starting_points, n_init = 1)
kmeans.fit(X);
...
#version requirements to upload
